...
def write_iterative(modelName, itrNum):
    ...
    if modelName == '170523_ITR_B':
        itr_170523_ITR_B(reCompileITR, trainLogDirBase, testLogDirBase, itrNum)
    elif modelName == '170622_ITR_B':
        itr_170622_ITR_B(reCompileITR, trainLogDirBase, testLogDirBase, itrNum)
    elif modelName == '170628_ITR_B':
        itr_170628_ITR_B(reCompileITR, trainLogDirBase, testLogDirBase, itrNum)
    elif modelName == '170706_ITR_B_inception':
        itr_170706_ITR_B_inception(reCompileITR, trainLogDirBase, testLogDirBase, itrNum)
    elif modelName == '170710_ITR_B_inception':
        itr_170710_ITR_B_inception(reCompileITR, trainLogDirBase, testLogDirBase, itrNum)
    elif modelName == '170711_ITR_B_inception':
        itr_170711_ITR_B_inception(reCompileITR, trainLogDirBase, testLogDirBase, itrNum)
    elif modelName == '170719_ITR_B_inception':
        itr_170719_ITR_B_inception(reCompileITR, trainLogDirBase, testLogDirBase, itrNum)
    elif modelName == '170720_ITR_B_inception':
        itr_170720_ITR_B_inception(reCompileITR, trainLogDirBase, testLogDirBase, itrNum)
    elif modelName == '170808_ITR_B_inception_n5tuple':
...
def itr_170523_ITR_B(reCompileITR, trainLogDirBase, testLogDirBase, itrNum):
    if reCompileITR:
...
def itr_170622_ITR_B(reCompileITR, trainLogDirBase, testLogDirBase, itrNum):
    if reCompileITR:
        data['modelName'] = 'twin_cnn_4p4l2f'
        data['imageDepthChannels'] = 2
        data['numParallelModules'] = 2
...
def itr_170628_ITR_B(reCompileITR, trainLogDirBase, testLogDirBase, itrNum):
    if reCompileITR:
        ...
        data['weightNorm'] = False
        write_json_file(runName+'.json', data)
def itr_170706_ITR_B_inception(reCompileITR, trainLogDirBase, testLogDirBase, itrNum):
    if reCompileITR:
...
def itr_170710_ITR_B_inception(reCompileITR, trainLogDirBase, testLogDirBase, itrNum):
    if reCompileITR:
        data['modelName'] = 'twin_cnn_4p4l2f_inception'
        data['numParallelModules'] = 2
        data['imageDepthChannels'] = 2
        ...
        data['weightNorm'] = False
        write_json_file(runName+'.json', data)
def itr_170711_ITR_B_inception(reCompileITR, trainLogDirBase, testLogDirBase, itrNum):
    if reCompileITR:
        data['modelName'] = 'twin_cnn_4p4l2f_inception'
        ...
        data['weightNorm'] = False
        write_json_file(runName+'.json', data)
def itr_170719_ITR_B_inception(reCompileITR, trainLogDirBase, testLogDirBase, itrNum):
    if reCompileITR:
        ...
        data['weightNorm'] = False
        write_json_file(runName+'.json', data)
def itr_170720_ITR_B_inception(reCompileITR, trainLogDirBase, testLogDirBase, itrNum):
    if reCompileITR:
        ...
        data['weightNorm'] = False
        write_json_file(runName+'.json', data)
def itr_170808_ITR_B_inception_n5tuple(reCompileITR, trainLogDirBase, testLogDirBase, itrNum):
    if reCompileITR:
        data['modelName'] = 'twin_cnn_4p4l3f_inception'
...
def recompile_json_files(modelName, itrNum):
    #write_single()
    #write_twin()
    #write_twin_correlation()
    successItr = write_iterative(modelName, itrNum)
    #write_residual()
    if successItr:
