...
#######################
# if false height will be 64 as we have 64 lidar lines
# if true height will be double sampled to have 128 lines
DOUBPLE_SAMPLE_HEIGHT_64_TO_128 = False
...
def _make_image(depthview, rXYZ):
    ...
    [-1.5519526    -0.26304439  0.282281DOUBPLE_SAMPLE_HEIGHT_64_TO_12807   $ -0.16448526 $  1.59919727]
    '''
    ### Flatten to a plane
    ...
    doubleSampleHeight = DOUBPLE_SAMPLE_HEIGHT_64_TO_128
    if doubleSampleHeight:
