...
def inference(images, **kwargs): #batchSize=None, phase='train', outLayer=[13,13], existingParams=[]
    ...
    fireOut, prevExpandDim = model_base.conv_fire_parallel_inception_module('conv1', images, int(images.get_shape()[3]),
                                                                  {'cnn3x3': modelShape[0]},
                                                                  wd, **kwargs)
   ...
   # calc batch norm CONV4_TWIN
    ...
    fireOut, prevExpandDim = model_base.conv_fire_parallel_inception_module('conv5', pool, prevExpandDim,
                                                         {'cnn3x3': modelShape[4]},
                                                         wd, **kwargs)
    ...
    fireOut, prevExpandDim = model_base.conv_fire_parallel_inception_module('conv6', fireOut, prevExpandDim,
                                                         {'cnn3x3': modelShape[5]},
                                                         wd, **kwargs)
    ...
    fireOut, prevExpandDim = model_base.conv_fire_parallel_inception_module('conv7', pool, prevExpandDim,
                                                         {'cnn3x3': modelShape[6]},
                                                         wd, **kwargs)
    ...
    fireOut, prevExpandDim = model_base.conv_fire_parallel_inception_module('conv8', fireOut, prevExpandDim,
                                                         {'cnn3x3': modelShape[7]},
                                                         wd, **kwargs)
    ...
    #prevExpandDim = (kwargs.get('imageDepthRows')//(2*2*2))*(kwargs.get('imageDepthCols')//(2*2*2))*prevLayerIndivDims
